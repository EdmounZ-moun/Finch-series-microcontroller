## Log 1, 26-12-2025
Started research of Finch V1 Devboard. This board uses a USB-C port for power transmission only, the data comes through an ISP-header, which is connected to the computer with an USBasp programmer
...
<img width="330" height="530" alt="Schermafbeelding 2026-07-21 000752" src="https://github.com/user-attachments/assets/ba208d07-c8c5-4013-b094-f86eda639dd9" /> (Ground is the blue part)
